...
const GENERATED_PRIVILEGED_STEPS: &[PrivilegedStepContract] = &[
    PrivilegedStepContract {
        ...
        body: PrivilegedStepBody::Action {
            uses: GENERATED_CHECKOUT_ACTION,
