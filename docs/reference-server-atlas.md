...
3. Start from the maintained toolkit template named by the delivery lane.
4. Extract only the generic substrate that at least two unrelated servers need.
5. Record the reference row used in the PR or work item evidence block.
