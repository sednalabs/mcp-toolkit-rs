...
Every MCP POST body is bounded before either the primary or compatibility
service parses it. The runtime default is 64 KiB and deployments may choose a
smaller or larger explicit bound to match their concurrency budget.
